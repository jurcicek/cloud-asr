...
_SAVERMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lattice', full_name='cloudasr.messages.SaverMessage.lattice', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alternatives', full_name='cloudasr.messages.SaverMessage.alternatives', index=7,
