...
CREATE TABLE `recording` (
  ...
  `wav_path` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `wav_url` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lat_path` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lat_url` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
